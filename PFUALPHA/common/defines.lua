...
military = {
	...
	NAVAL_COMBAT_DAMAGE_STR_MULT = 0.6, -- scale the damage to STR for balancing gameplay
	...
	NAVAL_COMBAT_RETREAT_STR_ORG_LEVEL = 0.1, -- the retreating is available when STR or ORG % drops below this value (it's 0% to 100% value)
